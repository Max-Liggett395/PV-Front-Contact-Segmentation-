...
# =====================================================================
CONFIG = {
    "architecture": "smp_unet",  # "unet", "smp_unet", "smp_deeplabv3plus", "smp_unetplusplus"
    "encoder_name": "resnet34",  # encoder backbone for smp models
    "encoder_weights": "imagenet",  # pretrained weights
    "in_channels": 3,            # 1=grayscale, 3=RGB-stacked
    "batch_size": 2,
    "max_epochs": 80,            # increased budget since model still improving at 50
    "lr": 5e-4,
    "weight_decay": 0.0,
    "dropout": 0.3,
...
def train():
    ...
    result["track"] = "track_architecture"
